public class Desktop extends ComputerSystem {
    ...
    public Desktop(int productId, String productName, int stock, double unitCost, boolean isActive, boolean isProductDiscount, CPU systemCPU, GPU systemGPU, RAM systemRam, Motherboard systemMotherboard, String OS,  Monitor systemMonitor, Keyboard systemKeyboard, Mouse systemMouse, Speaker systemSpeaker, boolean gamingSystem) {
